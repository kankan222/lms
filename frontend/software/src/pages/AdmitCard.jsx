...
export default function AdmitCard() {
  ...
  return (
    <>
      ...
      <TopBar title="Admit Card" subTitle="Download exam admit cards two per page" />
        ...
        <div className="grid gap-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate two landscape admit cards per PDF page for the selected exam scope.</CardDescription>
            </CardHeader>
